...
import { ClerkLoaded, SignedOut, SignedIn, SignUpButton, SignInButton } from '@clerk/nextjs'
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden px-4 pb-8 pt-32 lg:pt-24">
      <AnimatedTitle>
        <h1 className="flex w-full flex-col items-center justify-center gap-2 text-balance py-6 text-center font-display text-3xl font-bold leading-normal tracking-tighter sm:text-4xl sm:leading-snug md:gap-6 md:text-6xl">
          <span>
            Мастер {''}
              ...
              <AnimatedListItem variants={item}>
                <SignInButton mode="modal">
                  <Button size="lg" className="w-full text-secondary">
                    <span className="truncate">У меня уже есть аккаунт</span>
                  </Button>
                </SignInButton>
              </AnimatedListItem>
            </AnimatedList>
